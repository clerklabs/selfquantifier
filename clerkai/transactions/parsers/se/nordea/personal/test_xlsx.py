...
def test_nordea_se_xlsx_transactions_parser():
    # type: () -> None
    transaction_file_path = join(test_data_dir_path, "export.personkonto.edited.xls")
    transactions_df = nordea_se_xlsx_transactions_parser(transaction_file_path)
...
def test_nordea_se_xlsx_transactions_parser_2():
    # type: () -> None
