...
def test_lhv_ee_csv_transactions_parser():
    # type: () -> None
    transaction_file_path = join(test_data_dir_path, 'EE123456789012345678_Account_Statement_2019-08-17.edited.csv')
    transactions_df = lhv_ee_csv_transactions_parser(
